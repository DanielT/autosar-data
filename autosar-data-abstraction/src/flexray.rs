...
impl FlexrayCluster {
    ...
    pub fn update_settings(&self, settings: &FlexrayClusterSettings) {
            ...
            .and_then(|fcv| fcv.get_or_create_sub_element(ElementName::FlexrayClusterConditional))
        {
            ...
            let _ = cluster_content
                ...
                .and_then(|apo| {
                    apo.set_character_data(CharacterData::String(settings.action_point_offset.to_string()))
                });
            let _ = cluster_content
                .get_or_create_sub_element(ElementName::Bit)
                .and_then(|bit| bit.set_character_data(CharacterData::Double(settings.bit)));
            let _ = cluster_content
                .get_or_create_sub_element(ElementName::CasRxLowMax)
                .and_then(|crlm| crlm.set_character_data(CharacterData::String(settings.cas_rx_low_max.to_string())));
            let _ = cluster_content
                .get_or_create_sub_element(ElementName::ColdStartAttempts)
                .and_then(|csa| {
                    csa.set_character_data(CharacterData::String(settings.cold_start_attempts.to_string()))
                });
            let _ = cluster_content
                .get_or_create_sub_element(ElementName::Cycle)
                .and_then(|apo| apo.set_character_data(CharacterData::Double(settings.cycle)));
            let _ = cluster_content
                .get_or_create_sub_element(ElementName::CycleCountMax)
                .and_then(|ccm| ccm.set_character_data(CharacterData::String(settings.cycle_count_max.to_string())));
            let _ = cluster_content
                .get_or_create_sub_element(ElementName::DetectNitError)
                .and_then(|dne| dne.set_character_data(CharacterData::String(settings.detect_nit_error.to_string())));
            let _ = cluster_content
                .get_or_create_sub_element(ElementName::DynamicSlotIdlePhase)
                .and_then(|dsip| {
                    dsip.set_character_data(CharacterData::String(settings.dynamic_slot_idle_phase.to_string()))
                });
            let _ = cluster_content
                .get_or_create_sub_element(ElementName::IgnoreAfterTx)
                .and_then(|iat| iat.set_character_data(CharacterData::String(settings.ignore_after_tx.to_string())));
            let _ = cluster_content
                .get_or_create_sub_element(ElementName::ListenNoise)
                .and_then(|ln| ln.set_character_data(CharacterData::String(settings.listen_noise.to_string())));
            let _ = cluster_content
                .get_or_create_sub_element(ElementName::MacroPerCycle)
                .and_then(|mpc| mpc.set_character_data(CharacterData::String(settings.macro_per_cycle.to_string())));
            let _ = cluster_content
                .get_or_create_sub_element(ElementName::MacrotickDuration)
                .and_then(|mpc| mpc.set_character_data(CharacterData::Double(settings.macrotick_duration)));
            let _ = cluster_content
                .get_or_create_sub_element(ElementName::MaxWithoutClockCorrectionFatal)
                .and_then(|mwccf| {
                    mwccf.set_character_data(CharacterData::String(
                        settings.max_without_clock_correction_fatal.to_string(),
                    ))
                });
            let _ = cluster_content
                .get_or_create_sub_element(ElementName::MaxWithoutClockCorrectionPassive)
                .and_then(|mwccp| {
                    mwccp.set_character_data(CharacterData::String(
                        settings.max_without_clock_correction_passive.to_string(),
                    ))
                });
            let _ = cluster_content
                .get_or_create_sub_element(ElementName::MinislotActionPointOffset)
                .and_then(|mapo| {
                    mapo.set_character_data(CharacterData::String(settings.minislot_action_point_offset.to_string()))
                });
            let _ = cluster_content
                .get_or_create_sub_element(ElementName::MinislotDuration)
                .and_then(|md| md.set_character_data(CharacterData::String(settings.minislot_duration.to_string())));
            let _ = cluster_content
                .get_or_create_sub_element(ElementName::NetworkIdleTime)
                .and_then(|nit| nit.set_character_data(CharacterData::String(settings.network_idle_time.to_string())));
            let _ = cluster_content
                .get_or_create_sub_element(ElementName::NetworkManagementVectorLength)
                .and_then(|nmvl| {
                    nmvl.set_character_data(CharacterData::String(
                        settings.network_management_vector_length.to_string(),
                    ))
                });
            let _ = cluster_content
                .get_or_create_sub_element(ElementName::NumberOfMinislots)
                .and_then(|nom| {
                    nom.set_character_data(CharacterData::String(settings.number_of_minislots.to_string()))
                });
            let _ = cluster_content
                .get_or_create_sub_element(ElementName::NumberOfStaticSlots)
                .and_then(|noss| {
                    noss.set_character_data(CharacterData::String(settings.number_of_static_slots.to_string()))
                });
            let _ = cluster_content
                .get_or_create_sub_element(ElementName::OffsetCorrectionStart)
                .and_then(|ocs| {
                    ocs.set_character_data(CharacterData::String(settings.offset_correction_start.to_string()))
                });
            let _ = cluster_content
                .get_or_create_sub_element(ElementName::PayloadLengthStatic)
                .and_then(|pls| {
                    pls.set_character_data(CharacterData::String(settings.payload_length_static.to_string()))
                });
            let _ = cluster_content
                .get_or_create_sub_element(ElementName::SafetyMargin)
                .and_then(|sm| sm.set_character_data(CharacterData::String(settings.safety_margin.to_string())));
            if let Some(sample_clock_period) = settings.sample_clock_period {
                let _ = cluster_content
                    .get_or_create_sub_element(ElementName::SampleClockPeriod)
                    .and_then(|scp| scp.set_character_data(CharacterData::Double(sample_clock_period)));
            ...
            let _ = cluster_content
                ...
                .and_then(|ssd| {
                    ssd.set_character_data(CharacterData::String(settings.static_slot_duration.to_string()))
                });
            let _ = cluster_content
                .get_or_create_sub_element(ElementName::SymbolWindow)
                .and_then(|sw| sw.set_character_data(CharacterData::String(settings.symbol_window.to_string())));
            ...
            if let Some(symbol_window_action_point_offset) = settings.symbol_window_action_point_offset {
                let _ = cluster_content
                    ...
                    .and_then(|swapo| {
                        swapo.set_character_data(CharacterData::String(symbol_window_action_point_offset.to_string()))
                    });
            ...
            let _ = cluster_content
                ...
                .and_then(|sficm| {
                    sficm.set_character_data(CharacterData::String(settings.sync_frame_id_count_max.to_string()))
                });
            if let Some(transceiver_standby_delay) = settings.transceiver_standby_delay {
                let _ = cluster_content
                    ...
                    .and_then(|tsd| tsd.set_character_data(CharacterData::Double(transceiver_standby_delay)));
            ...
            let _ = cluster_content
                ...
                .and_then(|tssd| {
                    tssd.set_character_data(CharacterData::String(
                        settings.transmission_start_sequence_duration.to_string(),
                    ))
                });
            let _ = cluster_content
                .get_or_create_sub_element(ElementName::WakeupRxIdle)
                .and_then(|wri| wri.set_character_data(CharacterData::String(settings.wakeup_rx_idle.to_string())));
            let _ = cluster_content
                .get_or_create_sub_element(ElementName::WakeupRxLow)
                .and_then(|wrl| wrl.set_character_data(CharacterData::String(settings.wakeup_rx_low.to_string())));
            let _ = cluster_content
                .get_or_create_sub_element(ElementName::WakeupRxWindow)
                .and_then(|wrw| wrw.set_character_data(CharacterData::String(settings.wakeup_rx_window.to_string())));
            let _ = cluster_content
                .get_or_create_sub_element(ElementName::WakeupTxActive)
                .and_then(|wta| wta.set_character_data(CharacterData::String(settings.wakeup_tx_active.to_string())));
            let _ = cluster_content
                .get_or_create_sub_element(ElementName::WakeupTxIdle)
                .and_then(|wti| wti.set_character_data(CharacterData::String(settings.wakeup_tx_idle.to_string())));
        }
    }
    ...
    pub fn create_physical_channel(
        ...
        let _ = channel
            ...
            .and_then(|cn| cn.set_character_data(CharacterData::Enum(cn_item)));
